...
if __name__=="__main__":
    ...
    print("After LSH, similar images. 10 bits/bin. Totally 12 bins.\n\n")
    ...
    print(rdd_similar_items2.filter(lambda x:x[0]=='3677454_2025195.zip-1' or x[0]=='3677454_2025195.zip-18').collect())
